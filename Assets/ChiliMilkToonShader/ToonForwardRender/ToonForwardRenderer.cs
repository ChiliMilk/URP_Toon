...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class ToonForwardRenderer : ScriptableRenderer
    {
        ...
        DrawOutlinePass m_RenderOutlineForwardPass;
        DrawToonObjectsPass m_RenderOpaqueForwardPass;
        DrawSkyboxPass m_DrawSkyboxPass;
        CopyDepthPass m_CopyDepthPass;
        CopyColorPass m_CopyColorPass;
        TransparentSettingsPass m_TransparentSettingsPass;
        DrawToonObjectsPass m_RenderTransparentForwardPass;
        ...
        public ToonForwardRenderer(ToonForwardRendererData data) : base(data)
        {
            ...
            m_RenderOutlineForwardPass = new DrawOutlinePass("Render Outline(SPR_Default)", true, RenderPassEvent.BeforeRenderingOpaques, RenderQueueRange.opaque, data.opaqueLayerMask, m_DefaultStencilState, stencilData.stencilReference);
            m_RenderOpaqueForwardPass = new DrawToonObjectsPass("Render Opaques", true, RenderPassEvent.BeforeRenderingOpaques, RenderQueueRange.opaque, data.opaqueLayerMask, m_DefaultStencilState, stencilData.stencilReference);
            ...
            m_RenderTransparentForwardPass = new DrawToonObjectsPass("Render Transparents", false, RenderPassEvent.BeforeRenderingTransparents, RenderQueueRange.transparent, data.transparentLayerMask, m_DefaultStencilState, stencilData.stencilReference);
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            EnqueuePass(m_RenderOpaqueForwardPass);
            EnqueuePass(m_RenderOutlineForwardPass);
